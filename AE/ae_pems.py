...
def get_loader(ds_name="PEMS04"):
    ...
    train_data = PEMSDataset(data_path=[
        "/home/zhoujianping/Research/GNN/TrafficPrediction/datasets/PEMS04/distance.csv",
        "/home/zhoujianping/Research/GNN/TrafficPrediction/datasets/PEMS04/data.npz"
    ],
        num_nodes=num_nodes,
        divide_days=[45, 14],
        time_interval=5,
    ...
    test_data = PEMSDataset(data_path=[
        "/home/zhoujianping/Research/GNN/TrafficPrediction/datasets/{}/distance.csv"
            .format(ds_name),
        "/home/zhoujianping/Research/GNN/TrafficPrediction/datasets/{}/data.npz"
            .format(ds_name)
    ],
        num_nodes=num_nodes,
        divide_days=[45, 14],
